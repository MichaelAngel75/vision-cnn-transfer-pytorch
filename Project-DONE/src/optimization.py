...
def get_loss():
    ...
    # DONE:  YOUR CODE HERE: select a loss appropriate for classification
    loss  = nn.CrossEntropyLoss()  # DONE:  YOUR CODE HERE
...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        # DONE:  YOUR CODE HERE: create an instance of the SGD
        ...
        # DONE:  YOUR CODE HERE: create an instance of the Adam
        # optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay
