...
def get_model_transfer_learning(model_name="resnet18", n_classes=50):
    ...
    #  RestNet uses "model.fc" 
    #  AlexNet, VGG, DenseNet, Inception uses "model.classifier"
    ...
    num_ftrs  = model_transfer.fc.in_features  # DONE:  YOUR CODE HERE
    

    # 2. Create a new linear layer with the appropriate number of inputs and
    #    outputs
    model_transfer.fc  =  nn.Linear(num_ftrs, n_classes)  # DONE:  YOUR CODE HERE
